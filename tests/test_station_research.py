...
class StationJobTests(unittest.TestCase):
    ...
    def test_one_failed_serpapi_query_completes_with_failures(self):
        serpapi_calls = {"n": 0}
        original = self.web.fetch
        ...
        self.assertGreaterEqual(report["records_ingested"], 1)
        self.assertGreaterEqual(serpapi_calls["n"], 2)
